export const serviceItems = [
  ...
  },
  {
    ...
    description: "Uitvoeren van elektrische installaties met betrouwbaarheid en vakmanschap.",
  },
  {
    src: "https://readdy.ai/api/search-image?query=emergency%20electrical%20service%20van%20professional%20technician%20working%20at%20night%2024%20hour%20service%20clean%20industrial%20background%20modern%20equipment&width=400&height=300&seq=service003&orientation=landscape",
    title: "Depannage Service",
    description: "Snelle en deskundige storingsdienst voor al uw problemen.",
  },
];
