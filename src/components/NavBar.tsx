  ...
  const customTheme: CustomFlowbiteTheme["navbar"] = {
    link: {
      ...
      active: {
        ...
        off: "border-b border-gray-100 text-gray-700 hover:bg-black dark:border-gray-700 dark:text-gray-400 dark:hover:bg-black dark:hover:text-white md:border-0 md:hover:bg-transparent md:hover:text-black md:dark:hover:bg-transparent md:dark:hover:text-white",
      },
      disabled: {
